...
#東南旅遊：https://www.settour.com.tw/ec/prodline/hdp/searchList.html?pager.currentPage=1&stype=&sp=&sc=&erpOrdInfo=&cond=台北市%2C%26%2321488%3B%26%2321271%3B&portTp=B2C&pst=&ped=&destinationShow=台北市&destination=TPE&ps1=&ps2=&pky=台北#
...
write.csv(alldata,"./R_class/R_0810/alldata.csv")
